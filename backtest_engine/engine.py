...
def run_backtest(csv_hour, csv_minute, tick_size=0.25, start_hour='08:00:00', end_hour='16:00:00', output_file='nq_backtest_final_all_requirements.csv'):
    ...
    try:
        ...
        df_hour = df_hour.set_index('timestamp').between_time(start_hour, end_hour).reset_index()
        ...
        df_min = df_min.set_index('timestamp').between_time(start_hour, end_hour).reset_index()
